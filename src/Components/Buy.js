...
function Aboutbuy() {
    return (
        <section class="bg-gray-50 bg-gray-8000">
            <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6 flex  flex-col items-center">
                <div class="mb-8 max-w-screen-md lg:mb-16 text-center ">
                    <h2 class="mb-4 text-4xl font-extrabold text-gray-900 dark:text-white">How to buy</h2>
                    <p class="text-gray-500 sm:text-xl dark:text-gray-400">We invest more resources than any other platform in making sure great support from real people is a click away, whenever</p>
                </div>
                <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-2 md:gap-8 md:space-y-0">
