...
function Count() {
    return (
        <section class="bg-white bg-gray-8000 relative">
            <div className="py-8 px-4 mx-auto gap-3 max-w-screen-xl lg:gap-8  lg:py-16 lg:grid-cols-1222 flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
